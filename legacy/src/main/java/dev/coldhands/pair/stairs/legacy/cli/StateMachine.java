...
import static dev.coldhands.pair.stairs.legacy.cli.State.*;
...
class StateMachine {
    ...
    private State initialOutput() {
        if (context.scoredPairCombinations.size() == 1) {
            ...
            out.println("""               
                    ...
                    %s
                    """.formatted(
                    PairPrinter.drawPairChoices(context.scoredPairCombinations, 3)));
    ...
    private State showSelection() {
        ...
        out.println("""
                ...
                """.formatted(
                selectionMessage,
                PairPrinter.drawPairStairs(context.allDevelopers, context.actualNextPairings)
        ));
