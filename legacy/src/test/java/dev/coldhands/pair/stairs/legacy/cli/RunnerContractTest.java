...
import static dev.coldhands.pair.stairs.legacy.TestUtils.unWindows;
...
interface RunnerContractTest {
    ...
    default void versionOutput(StdIO stdIO) {
        ...
        givenTheManifestContainsLine("Implementation-Title: legacy");
    ...
    static void givenTheManifestContainsLine(String manifestLine) {
        ...
        assertThat(found)
                .describedAs(STR."manifest to contain line \{manifestLine}")
                .isTrue();
