...
class StreamContextIsMaintainedRuleTest {
    ...
    private final StreamContextIsMaintainedRule underTest = new StreamContextIsMaintainedRule(combinationHistoryRepository);
