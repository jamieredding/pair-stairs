...
class RunnerViaDockerImageIT extends RunnerContractIT {
    ...
    private static final String PATH_TO_SCRIPT = BASE_DIR + "/" + PROPERTIES.getProperty("scriptName");
    private static final Path CONFIG_FILE_PATH_INSIDE_CONTAINER = Path.of("data/config.json");
    private static final Path CONFIG_FILE_PATH_OUTSIDE_CONTAINER = Path.of(DATA_DIR + "/config.json");
