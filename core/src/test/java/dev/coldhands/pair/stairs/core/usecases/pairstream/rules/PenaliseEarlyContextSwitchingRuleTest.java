...
class PenaliseEarlyContextSwitchingRuleTest implements BaseRuleTest<PairStream> {
    ...
    void itIsWorseForMoreDevelopersToContextSwitch() {
        ...
        final var yesterday = new Combination<>(Set.of(
                new PairStream(Set.of("a-dev", "d-dev"), "1-stream"), // d swapped
                new PairStream(Set.of("c-dev"), "2-stream"),
                new PairStream(Set.of("e-dev", "b-dev"), "3-stream")  // b swapped
        ));
        ...
        final var oneDevSwitchesEarly = new Combination<>(Set.of(
                ...
                new PairStream(Set.of("c-dev", "d-dev"), "2-stream"), // d switches early
                new PairStream(Set.of("e-dev", "b-dev"), "3-stream")
        ));
        final var twoDevsSwitchEarly = new Combination<>(Set.of(
                new PairStream(Set.of("a-dev", "b-dev"), "1-stream"), // b switches early
                new PairStream(Set.of("c-dev", "d-dev"), "2-stream"), // d switches early
                new PairStream(Set.of("e-dev"), "3-stream")
        ));
    ...
    class MissingParts {
        ...
        void doNotContributeToScoreIfDeveloperWasOffYesterday() {
            ...
            final var dReturns = new Combination<>(Set.of(
                    ...
                    new PairStream(Set.of("a-dev", "d-dev"), "2-stream")
            ));
