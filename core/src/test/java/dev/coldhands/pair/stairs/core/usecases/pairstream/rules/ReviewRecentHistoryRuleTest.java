...
class ReviewRecentHistoryRuleTest {
    ...
    private final ReviewRecentHistoryRule underTest = new ReviewRecentHistoryRule(combinationHistoryRepository, Set.of("a-dev", "b-dev", "c-dev"), Set.of("1-stream", "2-stream"));
    ...
    todo
        ...
        - plus score if
            - one pair doesn't change from yesterday?
     */
}