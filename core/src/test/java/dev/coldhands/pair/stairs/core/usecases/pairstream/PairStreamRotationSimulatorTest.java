...
class PairStreamRotationSimulatorTest {
    ...
    void runForThreeSteps() {
        ...
        assertThat(repository.getMostRecentCombinations(5).reversed()) // more than 3 to ensure no more are in there
                .containsExactlyElementsOf(actualCombinations)
        ;
    }
    ...
    void trialWithRealData() {
        ...
        assertThat(uniqueDeveloperPairsResult)
                .satisfies(result -> {
                    ...
                    assertThat(result.summaryStatistics().populationVariance())
                            .isLessThan(26); // Current best score is 18.8000 (or 9.59999 via maven)
                });
        ...
        assertThat(developerDaysInStreamResult)
                .satisfies(result -> {
                    ...
                    assertThat(result.summaryStatistics().populationVariance())
                            .isLessThan(10); // Current best score is 2.33333 (or 3.777777 via maven)
                });
    }
